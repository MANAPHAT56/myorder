...
export default function MyShopPage({ user, notify }) {
  ...
  const statusBadge = (s) => {
    if (s === "pending")
      return <span className="badge badge-yellow">⏳ รอตรวจสอบ</span>;
    if (s === "approved")
      ...
      <div className="section" style={{ paddingTop: 28 }}>
        ...
        <div className="dash-card" style={{ marginBottom: 16 }}>
          ...
          <div className="detail-row">
            ...
            >
              {shop.created_at?.substring(0, 10)}
            </div>
          </div>
        </div>
        ...
        {tier === 1 && (
          <div
            ...
            style={{
              marginBottom: 16,
              background:
                "linear-gradient(135deg,#fff7f5,#fef3ee)",
              border: "1.5px solid rgba(232,93,38,0.2)",
            }}
          >
            <div
              ...
              <div className="history-item" key={i}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {h.admin_remark && (
                    ...
                    >
                      เหตุผลที่ไม่ผ่าน: {h.admin_remark}
                    </div>
                  )}
                  <div
                    style={{
